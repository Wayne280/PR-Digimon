...
with open('digi_csv.csv', 'w', newline='\n') as csvku:
    labelwriter = csv.writer(csvku, delimiter = ",")
    labelwriter.writerow(label)
    datawriter = csv.DictWriter(csvku, delimiter=",", fieldnames = label)
    datawriter.writerows(datadigimon)